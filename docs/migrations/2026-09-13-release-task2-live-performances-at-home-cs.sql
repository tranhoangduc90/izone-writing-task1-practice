-- Dữ liệu nhận vào: activity đề biểu diễn trực tiếp ở trạng thái bản nháp, manifest
...
BEGIN
  ...
  IF v_activity_count <> 1
    ...
    RAISE EXCEPTION
      'Phát hành đề biểu diễn trực tiếp chưa đạt: activity=%, sections=%, definition diff=%, scopes=%, class diff=%, roster diff=%, scope rỗng=%, alias trùng=%, provisional=%.',
      v_activity_count,
      v_section_count,
