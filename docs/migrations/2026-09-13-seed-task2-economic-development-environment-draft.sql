-- Dữ liệu nhận vào: manifest đề về phát triển kinh tế và môi trường đã qua validator và activity
...
VALUES(
  '8b190448-742b-44fb-8972-9191b012c9d8',
  'writing-task2-economic-development-environment',
  '2026-09-13.1',
  '40f59639f512e633cb4214a311d07f6a4eff57180bb98e73ffb630bbcd118379',
  'Luyện Writing Task 2: Phát triển kinh tế hay bảo vệ môi trường',
  'Some people believe economic development should be the main priority for governments, while others think protecting the natural environment is more important. Discuss both views and give your own opinion.',
...
BEGIN
  ...
  WHERE slug = 'writing-task2-economic-development-environment'
    AND content_version = '2026-09-13.1'
    AND public_id = '8b190448-742b-44fb-8972-9191b012c9d8'
    AND manifest_checksum = '40f59639f512e633cb4214a311d07f6a4eff57180bb98e73ffb630bbcd118379'
    AND task_prompt = 'Some people believe economic development should be the main priority for governments, while others think protecting the natural environment is more important. Discuss both views and give your own opinion.'
    AND prompt_registry_key = 'ielts:writing:task2:web:prompt_registry:v1'
    AND prompt_record_ref = 'task2-web-template-v1'
    AND prompt_version = '2026-08-19.1'
    AND grading_pool = 'task2'
  ...
  IF v_activity_count <> 1
    ...
    RAISE EXCEPTION
      'Seed đề phát triển kinh tế và môi trường chưa đạt: activity=%, status=%, sections=%, lệch định nghĩa=%, scope active=%.',
      v_activity_count,
      v_activity_status,
      v_section_count,
