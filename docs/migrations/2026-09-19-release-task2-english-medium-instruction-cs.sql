-- Dữ liệu nhận vào: activity đề tiếng Anh làm ngôn ngữ giảng dạy ở trạng thái bản nháp, manifest
-- đúng checksum và hai class scope hiện hành của đề kinh tế–môi trường.
...
BEGIN
  ...
  IF v_activity_count <> 1
    ...
    RAISE EXCEPTION
      'Phát hành đề tiếng Anh làm ngôn ngữ giảng dạy chưa đạt: activity=%, sections=%, definition diff=%, scopes=%, class diff=%, roster diff=%, scope rỗng=%, alias trùng=%, provisional=%.',
      v_activity_count,
      v_section_count,
