...
Manifest dùng contract `task1-web-manifest-v1` do Content Factory xuất: định danh hoạt động, đề/ảnh, cách đọc dữ liệu, phân tích, routes, vocabulary, chatbot và phiên bản nội dung/prompt. Các route có `recommended: true` luôn hiển thị đầu tiên; từ vựng hiển thị dạng mở rộng/thu gọn. Chỉ đưa nội dung có thể công khai vào manifest.
